export default function MobileApp() {
  return (
    <div className="flex flex-col md:flex-row justify-between items-center bg-primary-brand-color bg-mobile-app md:rounded-lg text-white">
      ...
      <picture className="hidden md:block self-end">
        <img
          className="pt-6"
